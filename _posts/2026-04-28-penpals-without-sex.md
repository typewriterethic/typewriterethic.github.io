...
In the years between my first and second marriage, I was a serial penpal. There were email exchanges that went on for years, in which I was able to do what I'm doing on __The Typewriter Ethic__. To express my thoughts about things and send them off into the world, although to an audience of one. The person on the receiving end of my emails would be one of two types. One was the type of penpal which wrote a reply the same day, no matter how long my most recent email had been. The other was the type of penpal that took weeks to respond, and always started their email with apologies and finished them with promises to be faster next time. 
